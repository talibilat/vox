...
graph TD
    ...
    subgraph Phase2["Phase 2 - The Conductor (multi-agent)"]
        ...
        I14["#14 tmux fallback transport (generic contingency)"]
    end
...
| 6 | #12, #13, #14 | #11 merged | Addressing/routing vs watchers/status vs tmux adapter live in disjoint files. #12 and #13 must agree the read/status interface signatures up front; #14's generic fallback stays dormant in normal configs. |
